...
CREATE TABLE `chart` (
  ...
  `WineCode` int NOT NULL,
  `Quantity` int NOT NULL,
  KEY `WineCode` (`WineCode`),
  KEY `CustomerCode` (`CustomerCode`),
  CONSTRAINT `chart_ibfk_1` FOREIGN KEY (`WineCode`) REFERENCES `wine` (`IDWine`),
  CONSTRAINT `chart_ibfk_2` FOREIGN KEY (`CustomerCode`) REFERENCES `customer` (`IDCustomer`)
